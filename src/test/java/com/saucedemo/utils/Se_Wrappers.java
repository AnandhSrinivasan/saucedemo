...
//	}
	...
	public void launchBrowser(@Optional("chrome") String browsername) {
	    try {
	        ...
	        Reports.reportStep("PASS", browsername + " browser launched successfully with the given URL.");
	    } catch (Exception ex) {
	        System.out.println("Problem in launching the browser");
	        Reports.reportStep("FAIL", "Problem while launching the " + browsername + " browser.");
	        ex.printStackTrace();
	    }
	}
